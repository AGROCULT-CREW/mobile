...
namespace Platform.Android
{
	public class PermissionProvider : MonoBehaviour
	{
		...
		public static event Action<bool> OnReceiveInternetPermission;
        ...
        public void VerifyInternet(Action<bool> action)
        {
            Debug.Log("[PermissionProvider] VerifyInternet");
            OnReceiveInternetPermission+= action;
            RequestPermissions(1001, "android.permission.INTERNET", "android.permission.ACCESS_NETWORK_STATE");
        }
